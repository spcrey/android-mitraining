...
public class NetworkActivity extends Activity {
    ...
    public static class GetCallback implements Callback {

        private WeakReference<NetworkActivity> ref;

        public GetCallback(NetworkActivity networkActivity) {
            this.ref = new WeakReference<>(networkActivity);
        }
        ...
        public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
            ...
            NetworkActivity networkActivity = ref.get();
            networkActivity.fromJson(string);
            Log.d(TAG, "get body: " + string);
            Log.d(TAG, "get headers: " + response.headers().toMultimap());
            networkActivity.handler.post(() -> networkActivity.textBody.setText(string));
        }
    }
    ...
    private void getWithCallback() {
        ...
        call.enqueue(new GetCallback(this));
    }
